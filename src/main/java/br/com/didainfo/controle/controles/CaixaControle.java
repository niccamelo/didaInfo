...
public class CaixaControle {
    ...
    public ModelAndView home() {
        ModelAndView modelAndView = new ModelAndView("caixa/home");
    ...
    public ModelAndView detalhes(@PathVariable Long id) {
        ModelAndView modelAndView = new ModelAndView("caixa/detalhes");

        modelAndView.addObject("caixa", caixaRepositorio.getOne(id));
    ...
    public ModelAndView editar(@PathVariable Long id) {
        ModelAndView modelAndView = new ModelAndView("caixa/formulario");
